...
| One phone stopped alarming, the others did not | Use **Stop the alarm** or **Stop and disarm everyone** on any phone, including one that has already gone quiet. Both reach the whole group. Since 1.6.0 the alarm panel stays on screen while *anybody* in the group is still alarming. |
